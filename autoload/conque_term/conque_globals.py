...
CONQUE_LOG_FILENAME = None

if os.path.exists('/home/nraffo/.vim/'):
    CONQUE_LOG_FILENAME = '/home/nraffo/.vim/pylog.log'
elif os.path.exists('C:/Documents and Settings/nraffo/vimfiles/'):
    CONQUE_LOG_FILENAME = 'C:/Documents and Settings/nraffo/vimfiles/pylog.log'
elif os.path.exists('/Users/nraffo/vimfiles/'):
    CONQUE_LOG_FILENAME = '/Users/nraffo/vimfiles/pylog.log'

CONQUE_LOG_LEVEL = logging.INFO

if CONQUE_LOG_FILENAME:
    logging.basicConfig(filename=CONQUE_LOG_FILENAME, level=CONQUE_LOG_LEVEL)
...
CONQUE_GRAPHICS_SET = [
    ...
    0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027, 0x0028, 0x0029, 0x002A, 0x2192, 0x2190, 0x2191, 0x2193, 0x002F,
    0x2588, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, 0x0038, 0x0039, 0x003A, 0x003B, 0x003C, 0x003D, 0x003E, 0x003F,
    ...
    0x25C6, 0x2592, 0x2409, 0x240C, 0x240D, 0x240A, 0x00B0, 0x00B1, 0x2591, 0x240B, 0x2518, 0x2510, 0x250C, 0x2514, 0x253C, 0xF800,
    0xF801, 0x2500, 0xF803, 0xF804, 0x251C, 0x2524, 0x2534, 0x252C, 0x2502, 0x2264, 0x2265, 0x03C0, 0x2260, 0x00A3, 0x00B7, 0x007F,
